<x-guest-layout>
    ...
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-slate-800">កំណត់ពាក្យសម្ងាត់ថ្មី</h2>
        <p class="text-sm text-slate-500 mt-1">បញ្ចូលពាក្យសម្ងាត់ថ្មីរបស់អ្នក</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
        ...
        <div>
            <label for="email" class="block text-sm font-medium text-slate-700 mb-1">អ៊ីមែល <span class="text-red-500">*</span></label>
            <div class="relative">
        ...
        <div>
            <label for="password" class="block text-sm font-medium text-slate-700 mb-1">ពាក្យសម្ងាត់ថ្មី <span class="text-red-500">*</span></label>
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-medium text-slate-700 mb-1">បញ្ជាក់ពាក្យសម្ងាត់ <span class="text-red-500">*</span></label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation"
                       ...
                       class="block w-full pl-10 rounded-lg border-slate-300 text-sm focus:border-indigo-500 focus:ring-indigo-500"/>
            </div>
