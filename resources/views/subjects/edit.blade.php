...
<x-card>
    <div class="p-6 space-y-4">
        <x-form-input label="លេខកូដ"          name="code"    :required="true" :value="$subject->code"/>
        <x-form-input label="ឈ្មោះ (ខ្មែរ)"   name="name_kh" :required="true" :value="$subject->name_kh"/>
        <x-form-input label="ឈ្មោះ (អង់គ្លេស)" name="name_en" :required="true" :value="$subject->name_en"/>
    </div>
